...
trg_obj = '/home/mint/AI_Source/pytorch3d/YLTset/surfaceMeshModels/dolphin.obj'
...
#isEmpty = trg_mesh.isempty
#print("trg mesh is empty=",isEmpty)
#vl = verts.verts_list
#print("verts_list=",verts_list)

# We initialize the source shape to be a sphere of radius 1
#src_mesh = ico_sphere(4, device)
src_obj = '/home/mint/AI_Source/pytorch3d/YLTset/surfaceMeshModels/test.obj'
verts1, face1, aux1 = load_obj(src_obj)
faces_idx1 = face1.verts_idx.to(device)
